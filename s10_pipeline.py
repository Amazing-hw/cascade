# -*- coding: utf-8 -*-
"""
Standalone cascade pipeline runner.
...
def main():
    ...
    p = argparse.ArgumentParser(description="Standalone cascade pipeline")
    ...
    print(f"\n{'='*60}\n  Cascade done ({total_elapsed:.1f}s / {format_duration(total_elapsed)})\n{'='*60}")
